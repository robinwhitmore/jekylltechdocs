...
You can access your settings from anywhere within your application code, including JavaScript, CSS, and templates. Please see the various sections for Templates, Javascript, and Stylesheets<!--todo: links--> for information on how to access them in each location.
