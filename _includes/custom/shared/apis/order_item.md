...
<h2>{% include label.html content="get" %} Retrieve a List of Order Items
</h2>
...
<h2>{% include label.html content="get" %} Retrieve the Number of Order Items for an Order
</h2>
{% highlight shell%}
{% if site.project == "platform" %}
...
<h2>{% include label.html content="get" %} Retrieve Details for an Order Item
</h2>
{% highlight shell%}
{% if site.project == "platform" %}
