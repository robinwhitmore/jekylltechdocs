...
<table>
    ...
    <tr>
        ...
        <td>Full url to your {% if site.project=="designer" %}<a href="ds_gs_market.html">publish</a>{% elsif site.project=="cloud" %}<a href="cl_gs_market.html">publish</a>{% endif %} promotion page. This url will be loaded
            ...
            level (using this {% if site.project=="designer" %}<a href="ds_api_site.html#patchupdate-a-site">Site API </a>{% elsif site.project=="cloud" %}<a href="cl_api_site.html#patchupdate-a-site">Site API </a>{% endif %}call).
        </td>
        <td>string</td>
        <td>X</td>
        <td>X</td>
